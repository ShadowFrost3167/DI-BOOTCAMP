...
//     const hondaName = carInventory.find(car => car.car_make===`Honda`);
//     if (hondaName){
//         return `This is a ${hondaName.car_make} ${hondaName.car_model} from ${hondaName.car_year}.`
//     } 
...
function sortCarInventoryByYear(carInventory){
    return carInventory.sort((car1, car2) => car1.car_year< car2.car_year ? -1: (car1.car_year > car2.car_year ? 1:0));
