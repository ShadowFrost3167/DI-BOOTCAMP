...
//it appears in the network >payload tab of the inspector BUT you must have the inspector and network tab open before submitting.
...
let marioMaker = JSON.stringify(marioGame, null , 2);

console.log(marioMaker);
